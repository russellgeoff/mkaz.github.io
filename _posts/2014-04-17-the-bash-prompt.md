...
<pre style="background:#002B36;"> <code> <span style="color:#2AA198;">limbo:</span> <span style="color:#859900;">~</span> <span style="color:#CB4B16;">&#x25ba;</span></code></pre>

Here's how I set my bash prompt, I source this [colors file ][1] and set using color names:


    source ~/dotfiles/extras/colors
    FANCY="\342\226\270"   # my fancy unicode prompt
...
<pre><code>0000000 <b>342 226 270</b> 012
0000004
</code></pre>
...
Well the simplest is really trying to copy and paste the character when you define, but it doesn't always work depending on terminal and operating system:
