...
So, in a similar vein as my [Python String Format Cookbook](https://mkaz.com/2012/10/10/python-string-format/), I wrote my own docs for argument parsing which I'll use myself as a reference and hopefully useful to you.
...
* [Official Argparse Documentation](https://docs.python.org/dev/library/argparse.html) - the official documentation is more complete, there are even more options to the module than I showed.

* [Official Argparse Tutorial](https://docs.python.org/2/howto/argparse.html) - More examples and the official walk through on using argparse.

* See my [Python String Format Cookbook](https://mkaz.com/2012/10/10/python-string-format/) for a similar tutorial with regards to string formatting
